...
from app.api.schemas import GeneratedCard
...
@router.post('/tasks/generate-with-sources', response_model=GeneratedCard)
async def generate_with_sources(payload: GenerateInput):
    return await ai.generate_with_sources(payload)
